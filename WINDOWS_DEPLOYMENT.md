...
Applies to Welcome System `0.9.15-beta`. For Mac, use [Mac Setup and Usage](MAC_DEPLOYMENT.md). For routine check-in on either platform, use the [Leader Guide](WELCOME_LEADER_README.md).
